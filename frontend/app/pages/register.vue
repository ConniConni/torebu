        ...
        <div>
          ...
          <div class="flex gap-2">
            <select
              ...
              class="w-full rounded border border-gray-300 dark:border-border-dark px-3 py-2 text-sm focus:border-brand-500 focus:outline-none dark:focus:border-accent disabled:bg-gray-100 dark:disabled:bg-white/5 bg-white dark:bg-panel text-gray-900 dark:text-ink"
            >
