...
- **未着手**：通知・ランキング・「イチオシこだわり共有」。`docs/schema.md`「Phase4の検討結果」の
...
- Phase2（部位ハイライト可視化）は完了済み。Phase4はグループ基盤・記録フィード・いいね・コメントまで
  着手済み。残る通知・ランキング・イチオシこだわり共有は「Phase4（交流とランキング）」
  セクション参照
